...
_SYSTEM_PROMPT = (
    ...
    "IMPORTANT: only apply a trade name when the product EXACTLY matches that type \u2014 "
    "never apply trade names from one product type to a different product. "
    "Trade names by specific product type (ONLY use when product matches):\n"
    "  BX/FLEX/NMD armored-cable conduit connector (NOT waterproof/liquidtight/direct-bury/butt/wire)="
    "\'dry connector\'/\'flex connector\'/\'not liquidtight\'\n"
    "  rubber no-hub drain pipe coupling (NOT toilet carrier/closet support)="
    "\'Fernco\'/\'mission coupling\'/\'rubber band coupler\'\n"
    "  P-trap drain fitting (NOT T-bar/T-ring/supply tube/faucet parts)="
    "\'bottle trap\'/\'u-bend\'/\'drain trap\'\n"
    "  plumbing push-fit PIPE coupling/elbow/tee (NOT electrical wire connectors/wago)="
    "\'push fit\'/\'push to connect\'/\'SharkBite\'\n"
    "  angle stop water supply valve (NOT supply tube/riser/faucet trim)="
    "\'under-sink valve\'/\'supply stop\'\n"
    "  3-pole miniature CIRCUIT BREAKER (NOT isolator/contactor/disconnect)="
    "\'triple pole MCB\'/\'three pole MCB\'\n"
    "  HVAC fabric flexible DUCT connector (NOT PVC flexible pipe/duct joiner)="
    "\'canvas connection\'/\'vibration isolator\'\n"
    "  ball valve=\'isolation valve\'/\'stopcock\'/\'quarter-turn\', "
    "GPO=\'power point\'/\'socket\'/\'general purpose outlet\', "
    "VAV terminal=\'VAV box\'/\'zone box\', "
    "fan coil=\'FCU\'/\'chilled water FCU\', "
    "RCBO=\'safety switch\'/\'GFCI\', "
    "Y-strainer=\'line strainer\'/\'basket strainer\'/\'y-strainer\', "
    "conduit saddle=\'conduit strap\'/\'pipe strap\', "
    "liquidtight connector=\'sealtight\'/\'watertight\', "
    "lug=\'cable lug\'/\'crimp lug\', "
    "MCB 3P=\'triple pole MCB\', "
    "AHU=\'rooftop unit\'/\'RTU\', TPS cable=\'flat cable\'/\'twin and earth\', "
