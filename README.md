...
| Metric    | @3    | @10   | @50   |
|-----------|-------|-------|-------|
| MRR       | 0.748 | 0.758 | 0.759 |
| Recall    | 0.811 | 0.867 | 0.889 |
| Miss      | 0.189 | 0.133 | 0.111 |

**By query type**

| Query type   | MRR@3 | R@3   | Miss@3 | MRR@10 | R@10  | Miss@10 |
|--------------|-------|-------|--------|--------|-------|---------|
| Model number | 0.983 | 1.000 | 0.000  | 0.983  | 1.000 | 0.000   |
| Technical    | 0.700 | 0.767 | 0.233  | 0.707  | 0.800 | 0.200   |
| Descriptive  | 0.561 | 0.667 | 0.333  | 0.583  | 0.800 | 0.200   |
